...
func CmdDewhitelisted() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "dewhitelisted [address]",
		Short: "Broadcast message dewhitelisted",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			argAddr := args[0]
			_, err = sdk.AccAddressFromBech32(argAddr)
			if err != nil {
